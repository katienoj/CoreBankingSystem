...
<div id="dashboard">
	...
	<div class="row">
        ...
        <div class="row">
		<a href="${page.url_host}${page.url_apppath}admin/loan/new"
			class="span4"> <img src="${page.url_assets}images/new_user.png"
			style="width: 80px;" /> <br />
		<h5>New Loan</h5>
		</a> <a href="${page.url_host}${page.url_apppath}admin/loan/search"
			class="span4"> <img src="${page.url_assets}images/list_board.png"
			style="width: 80px;" /> <br />
		<h5>Search Loan</h5>
		</a>
