...
<header class="navbar" id="header">
	<div class="navbar-inner">
		<div style="width: auto;" class="container">
			...
			</a> <a href="#" class="brand">Maendeleo-CB</a>
			<div class="nav-collapse">
				<ul class="nav">
					<li><a
						href="${page.url_host}${page.url_apppath}admin/dashboard">Dashboard</a></li>
					<li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#">Customers <b class="caret"></b></a>
					...
					<li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#">Bank Accounts<b
							class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a
							...
							<li><a
								href="${page.url_host}${page.url_apppath}admin/account/search">Search
									Account</a></li>
                                                ...
                                                <li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#">Loans<b
							class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a
								href="${page.url_host}${page.url_apppath}admin/loan/new">Add Loan
									</a></li>
							<li><a
								href="${page.url_host}${page.url_apppath}admin/loan/search">Search
									Loan</a></li>
						</ul></li>
					<li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#">Bank Branches<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="${page.url_host}${page.url_apppath}session/logout">Logout</a></li>
						</ul></li>
				</ul>
			</div>
			<!-- /.nav-collapse -->
