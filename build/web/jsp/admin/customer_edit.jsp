	...
	<table class="table">
		...
		<tr>
			...
			<td><input value="${data.nric}" name="nric" type="text" autocomplete="off"
				required="required" placeholder="ID/Passport" /></td>
		</tr>
		<tr>
			<td>Username</td>
		...
		<tr>
			...
			<td><input value="${data.givenname}" name="givenname" autocomplete="off"
				type="text" required="required" placeholder="Full Name" /></td>
		</tr>
		<tr>
			<td>Address</td>
		...
		<tr>
			...
			<td><input name="date_of_birth" value=""
				id="date_of_birth" type="text" required="required" placeholder="Date of Birth" /></td>
		</tr>
		<tr>
			<td>Date Added</td>
